<template>
    <div>
        <div class="page">
                ...
                <div class="main-sidemenu">
                    ...
                    <ul class="side-menu">
                        ...
                        <li class="slide">
                            <a class="side-menu__item" href="index.html"
                                ><span class="side-menu__label">
                                    <i class="fa fa-cubes"></i> Store</span
                                ><span
                        ...
                        <li class="slide">
                            <a class="side-menu__item" href="index.html"
                                ><span class="side-menu__label">
                                    <i class="far fa-file-alt"></i> Report</span
                                ><span
                                    class="badge bg-success text-light"
                                    id="bg-side-text"
                                    >1</span
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li>
                                    <a class="slide-item" href="#">Level1</a>
                                </li>
                                <li class="sub-slide">
                                    <a
                                        ...
                                        ><span class="sub-side-menu__label"
                                            >Level2</span
                                        ><i
                                            class="sub-angle fe fe-chevron-down"
                                        ></i
                                    ></a>
                                    <ul class="sub-slide-menu">
                                        ...
                                        <li class="sub-slide-sub">
                                            <a
                                                class="sub-side-menu__item sub-slide-item"
                    ...
                    <div class="container-fluid">
                        <div class="main-header-left">
                            ...
                            >
                                ...
                                <button class="btn">
                                    <i
                                        class="fas fa-search d-none d-md-block"
                                    ></i>
                                </button>
                            </div>
                        </div>
                            ...
                            <ul class="nav nav-item navbar-nav-right ms-auto">
                                <li class="nav">
                                    ...
                                    >
                                        ...
                                        >
                                            <span
                                                class="avatar country-Flag me-0 align-self-center bg-transparent"
                                                ><img
                                ...
                                <li
                                    class="dropdown nav-item main-header-message"
                                >
                                    ...
                                    <div class="dropdown-menu">
                                        <div
                                            class="menu-header-content bg-primary text-start"
                                        >
                                            <div class="d-flex">
                                                <h6
                                                    class="dropdown-title mb-1 tx-15 text-white fw-semibold"
                                                >
                                                    Messages
                                                </h6>
                                                <span
                                        ...
                                        <div
                                            class="main-message-list chat-scroll"
                                        >
                                            <a
                                                href="#"
                                            ...
                                            >
                                                ...
                                                <div class="wd-90p">
                                                    ...
                                                    <p
                                                        class="time mb-0 text-start float-start ms-2 mt-2"
                                                    >
                                                        Mar 15 3:55 PM
                                                    </p>
                                                </div>
                                        ...
                                        <div
                                            class="text-center dropdown-footer"
                                        >
                                ...
                                <li
                                    class="dropdown nav-item main-header-notification"
                                >
                                    <a class="new nav-link" href="#">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        >
                                            ...
                                            >
                                                <div class="notifyimg bg-pink">
                                                    <i
                                                        class="la la-file-alt text-white"
                                                    ></i>
                                                </div>
                                                <div class="ms-3">
                                                    <h5
                                                ...
                                                <div class="ms-auto">
                                                    <i
                                                        class="las la-angle-right text-end text-muted"
                                                    ></i>
                                                </div>
                                            </a>
                                            <a
                                            ...
                                            >
                                                <div
                                                    class="notifyimg bg-purple"
                                                >
                                                    <i
                                                        class="la la-gem text-white"
                                                    ></i>
                                                </div>
                                                <div class="ms-3">
                                                    <h5
                                            ...
                                            >
                                                <div
                                                    class="notifyimg bg-success"
                                                >
                                                    <i
                                                        class="la la-shopping-basket text-white"
                                                    ></i>
                                                </div>
                                                <div class="ms-3">
                                                    <h5
                                            ...
                                            >
                                                <div
                                                    class="notifyimg bg-warning"
                                                >
                                                    <i
                                                        class="la la-envelope-open text-white"
                                                    ></i>
                                                </div>
                                                <div class="ms-3">
                                                    <h5
                                            ...
                                            >
                                                <div
                                                    class="notifyimg bg-danger"
                                                >
                                                    <i
                                                        class="la la-user-check text-white"
                                                    ></i>
                                                </div>
                                                <div class="ms-3">
                                                    <h5
                                            ...
                                            >
                                                ...
                                                >
                                                    <i
                                                        class="la la-check-circle text-white"
                                                    ></i>
                                                </div>
                                                <div class="ms-3">
                                                    <h5
                                ...
                                <li
                                    class="dropdown main-header-message right-toggle"
                                >
                                    <a
                                        class="nav-link pe-0"
                            ...
                            <ul class="nav panel-tabs">
                                <li class="">
                                    <a
                                        ...
                                        data-bs-toggle="tab"
                                        ><i
                                            class="ion ion-md-chatboxes tx-18 me-2"
                                        ></i>
                                        Chat</a
                                    >
                                </li>
                                <li>
                                    <a href="#side2" data-bs-toggle="tab"
                                        ><i
                                            class="ion ion-md-notifications tx-18 me-2"
                                        ></i>
                                        Notifications</a
                                    >
                                </li>
                                <li>
                                    <a href="#side3" data-bs-toggle="tab"
                                        ><i
                                            class="ion ion-md-contacts tx-18 me-2"
                                        ></i>
                                        Friends</a
                                    >
                                </li>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="side1">
                                ...
                                >
                                    <div class="">
                                        <span
                                            class="avatar bg-primary brround avatar-md"
                                            >CH</span
                                        >
                                    </div>
                                    <a class="wrapper w-100 ms-3" href="#">
                                        ...
                                        >
                                            ...
                                            >
                                                <i
                                                    class="mdi mdi-clock text-muted me-1"
                                                ></i>
                                                <small
                                ...
                                >
                                    <div class="">
                                        <span
                                            class="avatar bg-danger brround avatar-md"
                                            >N</span
                                        >
                                    </div>
                                    <a class="wrapper w-100 ms-3" href="#">
                                ...
                                >
                                    <div class="">
                                        <span
                                            class="avatar bg-info brround avatar-md"
                                            >S</span
                                        >
                                    </div>
                                    <a class="wrapper w-100 ms-3" href="#">
                                ...
                                >
                                    <div class="">
                                        <span
                                            class="avatar bg-warning brround avatar-md"
                                            >K</span
                                        >
                                    </div>
                                    <a class="wrapper w-100 ms-3" href="#">
                                ...
                                >
                                    <div class="">
                                        <span
                                            class="avatar bg-success brround avatar-md"
                                            >R</span
                                        >
                                    </div>
                                    <a class="wrapper w-100 ms-3" href="#">
                                ...
                                >
                                    <div class="">
                                        <span
                                            class="avatar bg-pink brround avatar-md"
                                            >MS</span
                                        >
                                    </div>
                                    <a class="wrapper w-100 ms-3" href="#">
                                ...
                                >
                                    <div class="">
                                        <span
                                            class="avatar bg-purple brround avatar-md"
                                            >L</span
                                        >
                                    </div>
                                    <a class="wrapper w-100 ms-3" href="#">
                                ...
                                <div class="list d-flex align-items-center p-3">
                                    <div class="">
                                        <span
                                            class="avatar bg-blue brround avatar-md"
                                            >U</span
                                        >
                                    </div>
                                    <a class="wrapper w-100 ms-3" href="#">
                            ...
                            <div class="tab-pane" id="side2">
                                <div class="list-group list-group-flush">
                                    ...
                                    >
                                        ...
                                        <div class="ms-3">
                                            <strong>Anthony</strong> New product
                                            Launching...
                                            <div class="small text-muted">
                                                5 hour ago
                                            </div>
                                    ...
                                    >
                                        ...
                                        <div class="ms-3">
                                            <strong>Olivia</strong> New Schedule
                                            Realease......
                                            <div class="small text-muted">
                                                45 minutes ago
                                            </div>
                                    ...
                                    >
                                        ...
                                        <div class="ms-3">
                                            <strong>Olivia</strong> Hey! there
                                            I' am available....
                                            <div class="small text-muted">
                                                12 minutes ago
                                            </div>
            ...
            >
                <div
                    class="modal-dialog modal-dialog-right chatbox"
                    role="document"
                >
                    <div class="modal-content chat border-0">
                        <div class="card overflow-hidden mb-0 border-0">
                            ...
                            <div class="action-header clearfix">
                                ...
                                <ul
                                    class="ah-actions actions align-items-center"
                                >
                                    <li class="call-icon">
                                        <a
                                            href=""
                            ...
                            <div class="card-body msg_card_body">
                                ...
                                <div class="d-flex justify-content-end">
                                    <div class="msg_cotainer_send">
                                        Hi Connor Paige i am good tnx how about
                                        you?
                        ...
                        <div class="modal-body mx-auto text-center p-7">
                            ...
                            <div class="mt-5">
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <a
                                            class="icon icon-shape rounded-circle text-white mb-0 me-3"
                                            href="#"
                                            data-bs-dismiss="modal"
                                            aria-label="Close"
                                        >
                                            <i
                                                class="fas fa-phone bg-danger text-white"
                                            ></i>
                                        </a>
                                    </div>
                                    <div class="col-4">
                            ...
                            <div class="mt-5">
                                <div class="row">
                                    <div class="col-4">
                                        ...
                                        >
                                            <i
                                                class="fas fa-volume-up bg-light text-dark"
                                            ></i>
                                        </a>
                                    </div>
                                    <div class="col-4">
                                        ...
                                        >
                                            <i
                                                class="fas fa-phone text-white bg-success"
                                            ></i>
                                        </a>
                                    </div>
                                    <div class="col-4">
                                        ...
                                        >
                                            <i
                                                class="fas fa-microphone-slash bg-light text-dark"
                                            ></i>
                                        </a>
                                    </div>
                                </div>
